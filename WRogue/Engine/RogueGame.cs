...
namespace djack.RogueSurvivor.Engine
{
    partial class RogueGame
    {
        ...
        readonly string[] CLOSE_DOOR_MODE_TEXT = new string[] { "CLOSE MODE - click an adjacent tile or press a direction, ESC cancels" };
        readonly string[] BARRICADE_MODE_TEXT = new string[] { "BARRICADE/REPAIR MODE - click adjacent tile or press a direction, ESC cancels" };
        readonly string[] BREAK_MODE_TEXT = new string[] { "BREAK MODE - click adjacent tile/self or press a direction, ESC cancels" };
        readonly string[] BUILD_LARGE_FORT_MODE_TEXT = new string[] { "BUILD LARGE FORTIFICATION - click adjacent tile or press a direction, ESC cancels" };
        readonly string[] BUILD_SMALL_FORT_MODE_TEXT = new string[] { "BUILD SMALL FORTIFICATION - click adjacent tile or press a direction, ESC cancels" };
        readonly string[] TRADE_MODE_TEXT = new string[] { "TRADE MODE - Y to accept the deal, N to refuse" };
        readonly string[] NEGOCIATE_TRADE_MODE_TEXT = new string[] { "NEGOCIATE TRADE MODE - click adjacent actor or press a direction, ESC cancels" }; // alpha10
        ...
        readonly string[] SWITCH_PLACE_MODE_TEXT = new string[] { "SWITCH PLACE MODE - click adjacent follower or press a direction, ESC cancels" };
        readonly string[] TAKE_LEAD_MODE_TEXT = new string[] { "TAKE LEAD MODE - click adjacent actor or press a direction, ESC cancels" };
        readonly string[] PULL_MODE_TEXT = new string[] { "PULL MODE - click adjacent object or press a direction, ESC cancels" }; // alpha10
        readonly string[] PUSH_MODE_TEXT = new string[] { "PUSH/SHOVE MODE - click adjacent target or press a direction, ESC cancels" };
        readonly string[] TAG_MODE_TEXT = new string[] { "TAG MODE - click adjacent tile or press a direction, ESC cancels" };
        readonly string[] SPRAY_MODE_TEXT = new string[] { "SPRAY MODE - click adjacent tile/self or press a direction, ESC cancels" };
        readonly string PULL_OBJECT_MODE_TEXT = "PULLING {0} - click adjacent tile or press a direction, ESC cancels";  // alpha10
        readonly string PULL_ACTOR_MODE_TEXT = "PULLING {0} - click adjacent tile or press a direction, ESC cancels";  // alpha10
        readonly string PUSH_OBJECT_MODE_TEXT = "PUSHING {0} - click adjacent tile or press a direction, ESC cancels";
        readonly string SHOVE_ACTOR_MODE_TEXT = "SHOVING {0} - click adjacent tile or press a direction, ESC cancels";
        readonly string[] ORDER_MODE_TEXT = new string[] { "ORDER MODE - follow instructions in the message panel, ESC cancels" };
        readonly string[] GIVE_MODE_TEXT = new string[] { "GIVE MODE - click adjacent actor or press a direction, ESC cancels" };
        readonly string[] THROW_GRENADE_MODE_TEXT = new string[] { "THROW GRENADE MODE - hover to aim, click or F to throw, ESC cancels" };
